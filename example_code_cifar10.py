...
if __name__=='__main__':
    ...
    # IID
    data_obj = DatasetObject(dataset='CIFAR10', n_client=n_client, seed=20, rule='iid', unbalanced_sgm=0, data_path=data_path)
    # unbalanced
    ...
    [avg_ins_mdls, avg_cld_mdls, avg_all_mdls, trn_sel_clt_perf, tst_sel_clt_perf, trn_cur_cld_perf,tst_cur_cld_perf,
         trn_all_clt_perf, tst_all_clt_perf] = train_FedSSG(data_obj=data_obj, act_prob=act_prob,
