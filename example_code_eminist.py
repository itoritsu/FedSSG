...
from utils.methods_feddisco import train_FedDisco
from utils.methods_feddc import train_FedDC
...
if __name__=='__main__':
    ...
    # Dirichlet (0.6)
    data_obj = DatasetObject(dataset='emnist', n_client=n_client, seed=20, unbalanced_sgm=0, rule='Drichlet', rule_arg=0.6, data_path=data_path)
    ...
    model_name = 'emnist_NN' # Model type
    ...
    [avg_ins_mdls, avg_cld_mdls, avg_all_mdls, trn_sel_clt_perf, tst_sel_clt_perf, trn_cur_cld_perf, tst_cur_cld_perf,
     trn_all_clt_perf, tst_all_clt_perf] = train_FedSSG(data_obj=data_obj, act_prob=act_prob, n_minibatch=n_minibatch,
    ...
    [avg_ins_mdls, avg_cld_mdls, avg_all_mdls, trn_sel_clt_perf, tst_sel_clt_perf, trn_cur_cld_perf,
     tst_cur_cld_perf, trn_all_clt_perf, tst_all_clt_perf] = train_FedDisco(data_obj=data_obj, act_prob=act_prob,
    ...
    [avg_ins_mdls, avg_cld_mdls, avg_all_mdls, trn_sel_clt_perf, tst_sel_clt_perf, trn_cur_cld_perf,
     tst_cur_cld_perf, trn_all_clt_perf, tst_all_clt_perf] = train_FedVRA(data_obj=data_obj, act_prob=act_prob,
                                                                          learning_rate=learning_rate,
                                                                          batch_size=batch_size, epoch=epoch,
                                                                          com_amount=com_amount,
                                                                          print_per=print_per,
